...
import { ArrowLeft, Eye, EyeOff, MapPin, Phone, Sparkles, UserRound, Mail, CheckCircle, Users, Calendar, ShieldCheck, Star, Check, X } from "lucide-react";
...
export default function Signup() {
  ...
  useEffect(() => {
    const particlesContainer = document.querySelector('.signup-particles');
    ...
    for (let i = 0; i < particleCount; i++) {
      ...
      particle.className = 'absolute rounded-full bg-gradient-to-r from-teal-400/15 to-emerald-400/15';
      particle.style.width = `${Math.random() * 25 + 10}px`;
      particle.style.height = particle.style.width;
      particle.style.left = `${Math.random() * 100}%`;
      particle.style.top = `${Math.random() * 100}%`;
      particle.style.animation = `float ${Math.random() * 12 + 8}s infinite ease-in-out`;
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await fetch("https://learnserver-backend.onrender.com/api/auth/signup", {
        method: "POST",
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-white to-emerald-50/40 px-4 py-12">
      {/* Animated background gradient */}
      <div className="absolute inset-0 bg-gradient-to-r from-teal-100/15 via-transparent to-emerald-100/15" />
      
      {/* Floating particles container */}
      <div className="signup-particles absolute inset-0 overflow-hidden" />
      
      {/* Animated orbs */}
      <div className="absolute -left-32 top-1/4 h-96 w-96 animate-pulse rounded-full bg-gradient-to-r from-teal-300/25 to-emerald-300/25 blur-3xl" />
      <div className="absolute -right-32 bottom-1/4 h-96 w-96 animate-pulse rounded-full bg-gradient-to-r from-emerald-300/25 to-teal-300/25 blur-3xl animation-delay-2000" />
      
      {/* Main card */}
      <div className="relative z-10 grid w-full max-w-7xl overflow-hidden rounded-3xl border border-white/80 bg-white/90 shadow-2xl backdrop-blur-xl transition-all duration-500 hover:shadow-3xl lg:grid-cols-2">
        {/* Left side - Form */}
        <div className="p-8 sm:p-12">
          <div className="mx-auto max-w-2xl">
            <div className="mb-10">
              ...
              <h1 className="mt-8 font-heading text-4xl font-bold text-gray-900 sm:text-5xl">
                Start Your Wellness
                <span className="block bg-gradient-to-r from-teal-500 to-emerald-600 bg-clip-text text-transparent">
                  Membership Today
                </span>
              </h1>
              <p className="mt-4 text-lg text-gray-600">
                Create your account once and we'll keep your class access, enrollment details, and member profile ready for you.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <UserRound size={20} className="absolute left-4 top-1/2 z-10 -translate-y-1/2 text-gray-400 group-focus-within:text-teal-500 transition-colors" />
                    <input
                      id="name"
                      name="name"
                      type="text"
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-teal-400/20 to-emerald-500/20 opacity-0 group-focus-within:opacity-100 transition-opacity duration-300" />
                    <Phone size={20} className="absolute left-4 top-1/2 z-10 -translate-y-1/2 text-gray-400 group-focus-within:text-teal-500 transition-colors" />
                    <input
                      id="mobile"
                      name="mobile"
                      type="tel"
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-teal-400/20 to-emerald-500/20 opacity-0 group-focus-within:opacity-100 transition-opacity duration-300" />
                  <MapPin size={20} className="absolute left-4 top-5 z-10 text-gray-400 group-focus-within:text-teal-500 transition-colors" />
                  <textarea
                    id="address"
                    name="address"
                    rows="3"
                    ...
                    onChange={handleChange}
                    required
                    className="relative w-full rounded-xl border border-gray-200 bg-white/80 px-12 py-4 text-gray-900 placeholder-gray-400 backdrop-blur-sm transition-all duration-300 focus:border-teal-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-teal-400/30 resize-none"
        ...
        <div className="relative hidden overflow-hidden bg-gradient-to-br from-teal-900 via-emerald-900 to-slate-900 p-10 text-white lg:block">
          ...
          <div className="relative z-10">
            ...
            <h2 className="mt-8 font-heading text-4xl font-bold leading-tight">
              One Account for
            ...
            <p className="mt-6 max-w-md text-lg leading-8 text-white/80">
              Signup keeps your class bookings and member details ready, so joining future programs is simple and seamless.
            </p>
              ...
              {[
                {
                  ...
                  description: "Get class recommendations based on your fitness level and goals."
                },
                {
                  icon: Calendar,
                  title: "Flexible Scheduling",
                  description: "Book and manage classes at your convenience, 24/7 access."
                },
                {
                  icon: ShieldCheck,
                ...
                },
                {
                  ...
                  description: "Access premium classes and wellness resources."
                },
              ].map((benefit, idx) => (
                <div 
                  key={idx}
                  className="group rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm transition-all duration-300 hover:bg-white/10 hover:scale-[1.02] hover:border-white/20"
                >
                  <div className="flex items-start gap-4">
                    <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br from-teal-500 to-emerald-500">
